...
def initialize(app):
    ...
    app.mainMenuButton = Button(app, "Main Menu", app.margins*4, app.height - buttonH/2 - app.margins*4, buttonW*0.75, buttonH/2, main.initialize, depth=6, fill=app.darkColor, secondaryFill='dimGray')
